...
<head>
    ...
    <title>Head Count Admin Homepage</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
				<h1>Welcome!</h1></br>
				<p>This is the homepage for the HeadCount admin page. The admin area is still under construction please chech back shortly for 
