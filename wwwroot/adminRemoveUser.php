...
$query = "SELECT * FROM member  ORDER BY username";
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
			<div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="adminRemoveUser.php" class="list-group-item active">Remove Users</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <form name="upServForm" action="deleteUser.php" method="post" >
        <?php
        ...
        $dropdown .= "\r\n</select>";
    ?>
     Users  <?php echo $dropdown; ?> <input type="submit" value="Delete" name="loadbtn">
</form>
        </div>
